...
async function main() {
  ...
  // Format: postgresql://postgres.ctrcrcgfkwexkjwbwwvh:[password]@aws-0-us-east-2.pooler.supabase.com:6543/postgres
  const connectionString = `postgresql://postgres.ctrcrcgfkwexkjwbwwvh:${password}@aws-0-us-east-2.pooler.supabase.com:6543/postgres`;
