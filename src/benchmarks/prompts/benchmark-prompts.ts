...
export function getPromptsByCategory(category: string): BenchmarkPrompt[] {
  return BENCHMARK_PROMPTS.filter(p => p.category === category);
}

export function getPromptsByDifficulty(difficulty: 'easy' | 'medium' | 'hard'): BenchmarkPrompt[] {
